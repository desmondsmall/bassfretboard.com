    ...
    return (
        <>
            <div className="absolute top-0 left-0 right-0 mt-8 text-center ">
                <h1 className="text-2xl text-gradient bg-gradient-to-t from-blue-200 via-cyan-100 to-sky-300 font-mono uppercase tracking-wide">Bass Trainer</h1>
                <h2 className="capitalize text-2xl font-mono">{title}</h2>
            </div>
